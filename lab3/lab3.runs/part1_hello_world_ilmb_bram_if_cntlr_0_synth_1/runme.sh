...
HD_PWD='C:/Users/Nathan Chen/Desktop/cs152b/cs152b/lab3/lab3.runs/part1_hello_world_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log part1_hello_world_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source part1_hello_world_ilmb_bram_if_cntlr_0.tcl
